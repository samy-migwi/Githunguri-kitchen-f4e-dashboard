...
SCHOOLS_LIST = [
    "William Ng'iru Secondary School",
    "Kagema Comprehensive School",
    ...
    "PCEA Matuguta Primary & Junior Secondary School",
    "Catholic Archdiocese Of Nairobi Gataka Primary School",
    "Miiri Primary",
    "Kambui Primary School",
    "Gathangari Primary School",
    "Githioro Primary School",
    "Gathaithi Primary",
    "Githiga Primary",
    "Gitiha Secondary School",
    "Kiambururu Secondary School",
    "PCEA Matuguta Secondary School",
    "Gatitu Primary",
    "Kanyore Primary School",
    "Ikinu Primary",
    "Gathiruini Primary School",
    "Kiambururu Comprehensive School",
    "Miguta Primary School",
    "Gathaithi Secondary School",
    "Ndireti Primary School",
    "Githima Primary",
    "Ihiga Primary",
    "Mitahato Primary School",
    "Gatina Primary School",
    "PCEA Mitahato Secondary School",
    "Kiawairia Secondary School",
    "Kibichoi Primary School",
    "Kanjai Primary",
    "Giathieko Primary School",
    "Miiri Secondary School",
    "Komothai Primary School",
    "Nyaga Primary School",
    "Kihuririo Primary School",
    "Ngewa Primary School",
    "Njunu Primary School",
    "Mathanja Primary School",
    "Gathugu Secondary School",
    "Kindiga Primary & Junior Secondary School",
    "Nyaga Secondary School",
    "Kiawaiguru Primary School",
    "Ceb Riamute Nursery, Primary & Junior Secondary School",
    "Mukuyu Secondary School",
    "Kigumo Secondary School",
    "Kiawairia Primary",
    "Gitombo Primary School",
    "Thuita Secondary School",
    "Thuita Primary School",
    "Kigumo Primary",
    "Ndireti Secondary School",
    "Kagema Secondary School",
    "Ngemwa Primary and Junior School",
    "Ciiko Primary",
    "Kamondo Primary and Junior School",
    "AK Magugu Comprehensive School",
    "Kahunira Comprehensive School",
    "PCEA Githunguri Comprehensive School",
    "Gathanji Comprehensive School",
    "Kiairia Comprehensive School",
    "PCEA Karia Comprehensive School",
    "P.C.E.A Ngemwa Secondary School",
    "Githunguri Technical & Secondary School",
